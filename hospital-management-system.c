...
void Front_MainMenu(void) // function decleration
{
    system("cls");
    int choose;
    Title(); // call Title function
...
void LoginScreen(void) // function for login screen
{
    ...
    char Username[15];
    char Password[15];
    char original_Username[25] = "Darsh";
    char original_Password[15] = "db31";
    char front_Username[25] = "Dhruvin";
    char front_Password[15] = "dg29";
    ...
    do
    {
        ...
        else if (strcmp(Username, front_Username) == 0 && strcmp(Password, front_Password) == 0)
        {
            printf("\n\n\n\t\t\t\t\t...Login Successfull...");
            printf("\n\t\t\t\t\t...Front Desk...");

            getch();
            Front_MainMenu(); // call MainMenu function
            break;
        }
        else
        {
